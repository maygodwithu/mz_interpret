...
class Grad:
    ...
    def __init__(
        ...
        save_all: bool = False,
        result_prefix: typing.Union[str, Path] = None,
        verbose: int = 1,
        **kwargs
    ):
        ...
        self._result_pre = result_prefix
    ...
    def gradXinput(self) -> np.array:
        ...
        for batch in self._validloader:
            ...
            inputs = batch[0]
            outputs = self._model.grad_forward(inputs)
