...
def main():
    query = sys.argv[2]
    #print(highlight_doc_shortest_span(open(sys.argv[1]).read(), query))
    ...
    #print(shorten_snippet(open(sys.argv[1]).read(), 'deep dish pizza'))
    #print(get_highest_density_window(open(sys.argv[1]).read(), 'deep dish pizza'))
    #print(highlight_doc_density(open(sys.argv[1]).read(), 'deep dish pizza'))
    print(shorten_snippet(open(sys.argv[1]).read(), query))
    print(get_highest_density_window(open(sys.argv[1]).read(), query))
